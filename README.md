...
- После входа по viewer-ссылке используется cookie-сессия (токен не сохраняется в URL навигации).
...
- Откройте галерею по персональной ссылке вида `/?viewer_id=...#k=...`.
